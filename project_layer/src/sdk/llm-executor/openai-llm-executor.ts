// OpenAI executor: maps shared LLM requests onto an OpenAI-compatible chat completions API.
import type {
  ILlmExecutor,
  LlmExecutionRequest,
  LlmExecutionResult,
...
export class OpenAiLlmExecutor implements ILlmExecutor {
...
function validateRealProviderConfig(config: RealProviderConfig, provider: "openai"): void {
  if (!config.apiKey) {
