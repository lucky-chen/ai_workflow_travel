...
export async function runImplementationGeneratorTests() {
...
async function testImplementationGeneratorProducesPlannedChanges(artifactStore, workspaceRoot) {
...
async function testProjectContextLoaderIgnoresDistFiles(workspaceRoot) {
    ...
    assert.equal(projectContext.relevantFiles.some((file) => file.path === "dist/ignored.txt"), false);
}
