...
export async function runImplementationContractTests() {
...
async function testImplementationContractSuccess(checker, workspaceRoot) {
...
async function testImplementationContractFailure(checker, workspaceRoot) {
    ...
    assert.equal(failResult.summary, 'Test command failed: node -e "process.stderr.write(\'contract failed\\n\'); process.exit(1)"');
