...
ImplementationGenerator -> ImplementationPromptBuilder: build(module_design_doc, project_context)
...
- `ImplementationStageRunner` passes accepted `generatedFiles` downstream as `inputArtifacts["generated_implementation_files"]`
