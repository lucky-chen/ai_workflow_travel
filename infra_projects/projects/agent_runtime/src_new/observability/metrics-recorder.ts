...
import type { Metrics, MetricsCollectInput, MetricsResult, MetricsSummary } from "./metrics.js";
...
export class MetricsRecorder extends PersistentObservabilityBuffer implements Metrics {
