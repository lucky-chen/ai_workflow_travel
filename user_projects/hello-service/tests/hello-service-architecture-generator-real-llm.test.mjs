...
const realLlmTaskId = "hello-service-architecture-generator-real-llm-task";
const runId = "5400-architecture-generator-real-llm";

export async function runHelloServiceArchitectureGeneratorRealLlmTest() {
  ...
  try {
    ...
    assert.match(document, /^# Technical Architecture/m);
...
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  runHelloServiceArchitectureGeneratorRealLlmTest().catch((error) => {
